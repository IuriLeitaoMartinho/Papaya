...
function marcosBurocracia(nasc) {
  ...
  return [
    ...
    { data: somarDias(nasc, 14), titulo: 'Pesagem de controlo (2 semanas)',
      sub: 'Confirma que recuperou o peso de nascimento. No centro de saúde, na consulta de enfermagem.',
      categoria: 'consulta', capitulo: '09-vacinas-consultas',
      seccao: 'Pesagens e curvas de crescimento' },
